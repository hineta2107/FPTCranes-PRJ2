...
These are descriptive results from the real pack, not literals embedded in page source. Test metrics did not select or promote a candidate or Top-2 configuration.
